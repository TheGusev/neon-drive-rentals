...
const TITLE = "Аренда авто в Новосибирске — от 1 800 ₽/сутки | RentSib";
const DESC =
  "Аренда авто в Новосибирске посуточно и на длительный срок. Японские кей-кары, доставка по городу, договор за 3 минуты, без крупного залога.";
...
function Page() {
  return (
    <LandingPage
      ...
      lead="RentSib — прокат автомобилей в Новосибирске с посуточной оплатой от 1 800 ₽. В автопарке 8 японских кей-каров с правым рулём: Honda N-BOX, Suzuki Wagon R, Nissan Dayz. Доставка по городу и в аэропорт Толмачёво."
      bullets={[
        ...
        "Доставка авто по Новосибирску и области",
      ...
      sections={[
        ...
        {
          h: "Доставка и выдача автомобиля",
          body: "Выдача в центре Новосибирска бесплатно. Доставка по городу — 500 ₽, в аэропорт Толмачёво — 800 ₽, встреча круглосуточно. Возврат — по любому из наших адресов или там, где удобно, за отдельную плату.",
        },
      ]}
      cars={cars.slice(0, 6)}
