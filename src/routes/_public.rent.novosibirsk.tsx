...
function Page() {
  return (
    <LandingPage
      ...
      lead="NSK-RENT — прокат автомобилей в Новосибирске с посуточной оплатой от 1 800 ₽. В автопарке 8 японских кей-каров с правым рулём: Honda N-BOX, Suzuki Wagon R, Nissan Dayz. Доставка по городу и в аэропорт Толмачёво."
      bullets={[
