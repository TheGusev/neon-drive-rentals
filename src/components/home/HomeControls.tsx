      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button
            ...
            aria-label="Меню"
            data-hidden="false"
            className="menu-pulse pointer-events-auto h-14 w-14 translate-y-0 rounded-2xl border-2 border-accent/70 bg-background/85 opacity-100 shadow-[0_0_24px_color-mix(in_oklab,var(--neon-blue)_55%,transparent)] backdrop-blur transition-[transform,opacity] duration-300 will-change-transform hover:border-accent data-[hidden=true]:pointer-events-none data-[hidden=true]:-translate-y-24 data-[hidden=true]:opacity-0 md:h-12 md:w-12 motion-reduce:transition-none"
          >
