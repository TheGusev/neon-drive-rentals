...
import nWgnWhite from "@/assets/cars/honda-n-wgn-white.jpg";
...
import dayzBrown from "@/assets/cars/nissan-dayz-brown.jpg";
...
import nBoxBlack from "@/assets/cars/honda-n-box-black.jpg";
...
const rows: Row[] = [
  ...
  { id: "honda-n-wgn-grey-2", brand: "Honda", model: "N-WGN", year: 2018, color: "серый", power: 58, consumption: 3.8, pricePerDay: 1900, rating: 4.8, reviewsCount: 41, plate: "А102ВС154", image: nWgnGrey },
  { id: "honda-n-wgn-blue", brand: "Honda", model: "N-WGN", year: 2016, color: "синий", power: 58, consumption: 4.0, pricePerDay: 1800, rating: 4.6, reviewsCount: 28, plate: "А103ВС154", image: nWgnBlue, status: "washing" },
  ...
  { id: "honda-n-wgn-white", brand: "Honda", model: "N-WGN", year: 2018, color: "белый", power: 58, consumption: 3.9, pricePerDay: 1900, rating: 4.7, reviewsCount: 52, plate: "А105ВС154", image: nWgnWhite, status: "busy", bookedDates: ["2026-08-08", "2026-08-09", "2026-08-10", "2026-08-11"] },
  { id: "honda-n-wgn-turbo-white", brand: "Honda", model: "N-WGN Custom Turbo", year: 2019, color: "белый", power: 64, consumption: 4.4, pricePerDay: 2700, rating: 4.9, reviewsCount: 128, plate: "А106ВС154", image: nWgnTurboWhite, deposit: 7000 },
  ...
  { id: "nissan-dayz-brown", brand: "Nissan", model: "Dayz", year: 2017, color: "коричневый", power: 49, consumption: 3.6, pricePerDay: 1800, rating: 4.6, reviewsCount: 23, plate: "В202ТР154", image: dayzBrown },
  ...
  { id: "nissan-dayz-white-1", brand: "Nissan", model: "Dayz", year: 2019, color: "белый", power: 52, consumption: 3.7, pricePerDay: 2000, rating: 4.8, reviewsCount: 58, plate: "В204ТР154", image: dayzWhite },
  { id: "nissan-dayz-white-2", brand: "Nissan", model: "Dayz Highway Star", year: 2019, color: "белый", power: 64, consumption: 4.3, pricePerDay: 2400, rating: 4.9, reviewsCount: 71, plate: "В205ТР154", image: dayzWhite, deposit: 6000 },
  ...
  { id: "daihatsu-mira-es-black-2", brand: "Daihatsu", model: "Mira e:S", year: 2018, color: "чёрный", power: 49, consumption: 3.6, pricePerDay: 1900, rating: 4.7, reviewsCount: 26, plate: "Е402КР154", image: miraEsBlack, bookedDates: ["2026-08-15", "2026-08-16", "2026-08-17"] },
  ...
  { id: "honda-n-box-black", brand: "Honda", model: "N-BOX", year: 2018, color: "чёрный", power: 58, consumption: 4.5, pricePerDay: 2300, rating: 4.9, reviewsCount: 87, plate: "М601ОР154", image: nBoxBlack, seats: 5, bodyType: "минивэн" },
  ...
  { id: "honda-n-wgn-black-2", brand: "Honda", model: "N-WGN", year: 2020, color: "чёрный", power: 58, consumption: 3.8, pricePerDay: 2200, rating: 4.9, reviewsCount: 63, plate: "А107ВС154", image: nWgnBlack, status: "busy", bookedDates: ["2026-08-09", "2026-08-10"] },
];
