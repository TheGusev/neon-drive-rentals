...
const rows: Row[] = [
  ...
  { id: "honda-n-wgn-blue", brand: "Honda", model: "N-WGN", year: 2016, color: "синий", power: 58, consumption: 4.0, pricePerDay: 1800, rating: 4.6, reviewsCount: 28, plate: "А103ВС154", image: nWgnBlueReal, gallery: [nWgnBlueReal, nWgnBlue] },
  ...
  { id: "nissan-dayz-black", brand: "Nissan", model: "Dayz", year: 2018, color: "чёрный", power: 52, consumption: 3.9, pricePerDay: 2000, rating: 4.7, reviewsCount: 44, plate: "В206ТР154", image: dayzBlackReal, gallery: [dayzBlackReal, dayzBlack], status: "maintenance" },
  { id: "mitsubishi-ek-wagon-blue", brand: "Mitsubishi", model: "eK Wagon", year: 2016, color: "чёрный", power: 49, consumption: 3.8, pricePerDay: 1800, rating: 4.5, reviewsCount: 16, plate: "С301МН154", image: ekWagonBlackReal, gallery: [ekWagonBlackReal, ekWagonSilverReal] },
  ...
  { id: "honda-n-box-black", brand: "Honda", model: "N-BOX", year: 2018, color: "чёрный", power: 58, consumption: 4.5, pricePerDay: 2300, rating: 4.9, reviewsCount: 87, plate: "М601ОР154", image: nBoxBlackReal3, gallery: [nBoxBlackReal3, nBoxBlackReal, nBoxBlackFrontReal, nBoxBlackReal2], seats: 5, bodyType: "минивэн" },
